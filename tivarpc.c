...
static int32_t RPC_MODE(uint32_t param_size, void *param)
{
   RGBEnable();
   return 0;
}
static int32_t RPC_GPIO(uint32_t param_size, void *param)
{
   RGBDisable();
...
static const rpc_function_prototype rpc_function_table[]={
                                            ...
                                            RPC_MODE, /* Cambia el modo 0 para GPIO 1 para PWM */
                                            RPC_GPIO,
